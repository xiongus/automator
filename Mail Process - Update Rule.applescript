...
# athmandest - https://talk.automators.fm/t/apple-mail-rule-updater/14079/4
...
tell application "Mail"
	set rName to name of every rule
end tell
copy "** New Rule ***" to the end of the rName
set rName to choose from list rName with prompt "Select Mail Rule" without empty selection allowed
...
if theRule = "** New Rule ***" then
	...
	set theResponse to display dialog "What's the name of the new Folder?" default answer "" with icon note buttons {"Continue"} default button "Continue"
